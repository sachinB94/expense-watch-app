...
gulp.task('templates', function() {
  return gulp.src('app/scripts/components/**/*.html')
    .pipe(gulp.dest(path.join(targetDir, 'scripts/components')))
...
gulp.task('vendor-styles', function() {
  var vendorFiles = require('./vendor-css.json');

  return gulp.src(vendorFiles)
    .pipe(plugins.concat('vendor.css'))
    .pipe(plugins.if(build, plugins.cssmin()))
    .pipe(plugins.if(build, plugins.rev()))
...
gulp.task('index', ['jsHint', 'scripts'], function() {
  ...
  return gulp.src('app/index.html')
    ...
    // inject vendor.css
    .pipe(_inject(gulp.src('vendor*.css', { cwd: targetDir }), 'vendor-styles'))
    // inject vendor.js
...
gulp.task('watchers', function() {
  ...
  gulp.watch('./vendor-css.json', ['vendor-styles']);
  gulp.watch('app/templates/**/*.html', ['index']);
  gulp.watch('app/scripts/components/**/*.html', ['index', 'templates']);
